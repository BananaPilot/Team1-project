package com.team1.app.classes.product;
...
import com.team1.app.classes.supplier.*;
...
class ProductTracking {
    ...
    @Override
    public String toString() {
        return "ProductTracking [com.team1.app.classes.in=" + in + ", currentQuantity=" + getTrackingQuantity() + ", out=" + out
