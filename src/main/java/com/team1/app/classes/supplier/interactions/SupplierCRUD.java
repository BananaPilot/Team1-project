...
public class SupplierCRUD {
    ...
    public Supplier getSupplier(List<Supplier> suppliers) {
        ...
        return switch (input) {
            ...
            case 4 -> Searchable.search(suppliers, In.getInstance().getString("Company name: "));
            case 5 -> Searchable.search(suppliers, In.getInstance().getInt("Supplied product type: "));
